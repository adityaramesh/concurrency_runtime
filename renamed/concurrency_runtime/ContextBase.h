...
namespace details
{
    ...
    public:
        ...
        /// <summary>
        ///     Returns an indication as to whether a cancellation is occuring at the specified depth. The result here is only valid when
        ...
        /// <summary>
        ///     Returns an indication as to whether a cancellation is occuring at the depth specified by the inlining depth of the given collection. This
