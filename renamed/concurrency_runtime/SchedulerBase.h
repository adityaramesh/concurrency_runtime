...
namespace details
{
    ...
    private:
        ...
        /// </summary>
        static void CALLBACK ThrottlerDispatchBridge(PTP_CALLBACK_INSTANCE instance, void * pContext, PTP_TIMER timer)
        {
        ...
        /// </summary>
        static void CALLBACK ThrottlerDispatchBridgeXP(PVOID pScheduler, BOOLEAN waitOrTimerFired)
        {
