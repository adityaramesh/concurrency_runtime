...
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _Plsw(double *);
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _Pmsw(double *);
...
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _Dscalex(double *, long, int);
...
_CRTIMP2_PURE double __CLRCALL_PURE_OR_CDECL _Xp_getw(const double *, int);
...
_CRTIMP2_PURE double *__CLRCALL_PURE_OR_CDECL _Xp_addx(double *, int,
	const double *, int);
_CRTIMP2_PURE double *__CLRCALL_PURE_OR_CDECL _Xp_subx(double *, int,
	const double *, int);
_CRTIMP2_PURE double *__CLRCALL_PURE_OR_CDECL _Xp_ldexpx(double *, int, int);
_CRTIMP2_PURE double *__CLRCALL_PURE_OR_CDECL _Xp_mulx(double *, int,
...
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _FPlsw(float *);
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _FPmsw(float *);
...
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _FDscalex(float *, long, int);
...
_CRTIMP2_PURE extern /* const */ _Dconst _FEps, _FRteps;
_CRTIMP2_PURE extern /* const */ float _FXbig, _FZero;

_CRTIMP2_PURE float __CLRCALL_PURE_OR_CDECL _FXp_getw(const float *, int);
...
_CRTIMP2_PURE float *__CLRCALL_PURE_OR_CDECL _FXp_addx(float *, int,
	const float *, int);
_CRTIMP2_PURE float *__CLRCALL_PURE_OR_CDECL _FXp_subx(float *, int,
	const float *, int);
_CRTIMP2_PURE float *__CLRCALL_PURE_OR_CDECL _FXp_ldexpx(float *, int, int);
_CRTIMP2_PURE float *__CLRCALL_PURE_OR_CDECL _FXp_mulx(float *, int,
...
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _LPlsw(long double *);
_CRTIMP2_PURE unsigned short *__CLRCALL_PURE_OR_CDECL _LPmsw(long double *);
...
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _LDscalex(long double *, long, int);
...
_CRTIMP2_PURE long double __CLRCALL_PURE_OR_CDECL _LXp_getw(const long double *, int);
...
_CRTIMP2_PURE long double *__CLRCALL_PURE_OR_CDECL _LXp_movx(long double *, int,
	const long double *);
...
_CRTIMP2_PURE long double *__CLRCALL_PURE_OR_CDECL _LXp_mulx(long double *, int,
