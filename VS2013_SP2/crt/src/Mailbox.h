...
namespace details
{
    ...
    public:
        ...
        Mailbox(SchedulerBase *pScheduler, const QuickBitSet& affinitySet, bool fDeferAlloc = false, unsigned int segmentSize = s_segmentSize) : 
    ...
    private:
        ...
        // Protect enqueue funciton, which should only accept one message for a time.
